...
from etos_theme_v13 import get_img

app_name = "etos_theme_v13"
app_title = "Etos Theme V13"
app_publisher = "AVU Business Solutions Pvt. Ltd."
app_description = "Custom ETos theme for version 13."
app_icon = "octicon octicon-file-directory"
app_color = "green"
app_email = "admin@avu.net.in"
app_license = "MIT"
app_logo_url = get_img()

email_brand_image = get_img()

website_context = {
	"favicon": 	get_img(),
	"splash_image": get_img()
}
